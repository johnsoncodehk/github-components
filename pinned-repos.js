...
const repos_html = `
<li class="github-pinned-repos-col-{div_id}" style="align-content: stretch; display: flex; margin-bottom: 16px; padding-left: 8px; padding-right: 8px;">
    <div style="background-color: rgb(255, 255, 255); border-color: rgb(209, 213, 218); border-radius: 3px; border-style: solid; border-width: 1px; display: flex; padding: 16px; width: 100%;">
        <div style="display: flex; flex-direction: column; width: 100%;">
            <div style="align-items: center; display: flex; position: relative; width: 100%;">
                <svg viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true" style="border-color: rgb(88, 96, 105); caret-color: rgb(88, 96, 105); color: rgb(88, 96, 105); fill: rgb(88, 96, 105); flex-shrink: 0; margin-right: 8px; vertical-align: text-bottom;"><path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"></path></svg>
                <a href="https://github.com/{full_name}" style="flex-grow: 1; font-weight: 600; min-width: 0px;">
                    <span title="{name}">{name}</span>
                </a>
            </div>
            <p style="border-color: rgb(88, 96, 105); caret-color: rgb(88, 96, 105); color: rgb(88, 96, 105); flex-grow: 1; flex-shrink: 0; font-size: 12px; margin-bottom: 16px; margin-top: 8px;">
                {description}
            </p>
...
for (const div of divs) {
    ...
    for (const repo of repos) {
        httpGet("https://api.github.com/repos/" + repo.name, repoJson => {
            ...
            repo.html = repos_html
                ...
                .replace("{network_html}", data.network_count ? (data.stargazers_count ? repos_network_html : repos_network_html_no_star) : "")
